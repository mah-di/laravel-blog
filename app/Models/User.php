...
{
    use HasApiTokens, HasFactory, Notifiable, HasDateCreatedTrait, HasUrlTrait;
    ...
    public function getLikedBlogsCountAttribute()
    {
        return $this->likes->where('likable_type', Blog::class)->count();
    }

    public function getLikedCommentsCountAttribute()
    {
        return $this->likes->where('likable_type', Comment::class)->count();
    }

    protected function getUrlAttribute(): string
    {
        return $this->constructUrl('profile');
    }
